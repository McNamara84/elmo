...
$envShowMslFreeKeywords = getenv('SHOW_MSL_FREEKEYWORDS');
...
if ($envShowMslFreeKeywords !== false) {
    $showMslFreeKeyWords = filter_var($envShowMslFreeKeywords, FILTER_VALIDATE_BOOLEAN);
}
