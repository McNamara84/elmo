...
function insertLookupData($connection)
{
    $lookupData = [
        ...
        "Rights" => [
            ...
            ["text" => "Creative Commons Attribution-NonCommercial 4.0 International (only by arrangement)", "rightsIdentifier" => "CC-BY-NC-4.0", "rightsURI" => "https://creativecommons.org/licenses/by-nc/4.0/legalcode.en", "forSoftware" => "0"]
        ],
        "Language" => [
