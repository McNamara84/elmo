...
class SubmitHandler {
    ...
    $.ajax({
      ...
      success: (response) => {
        ...
        try {
          ...
          this.showNotification("danger", translations.alerts.errorHeading, translations.alerts.submitError);
          return;
        }

        if (parsedResponse.success) {
          this.showNotification("success", translations.alerts.successHeading, parsedResponse.message);
          if (this.autosaveService) {
          ...
          this.showNotification("danger", translations.alerts.errorHeading, errorMessage);
          if (debugInfo) {
  ...
  handleAjaxError(xhr, textStatus, errorThrown) {
    ...
    this.showNotification("danger", translations.alerts.errorHeading, errorMessage || translations.alerts.submitError);
  }
