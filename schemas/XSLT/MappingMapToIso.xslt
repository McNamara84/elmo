					...
					<MD_DataIdentification>
						...
						<descriptiveKeywords>
							...
							<xsl:for-each select="(./*[local-name()='ThesaurusKeywords' and namespace-uri()='']/*[local-name()='Keyword' and namespace-uri()=''])[contains(*[local-name()='scheme' and namespace-uri()=''], 'https://epos-msl.uu.nl/voc/testbeds/1.3/')]">
								<xsl:variable name="var33_filter" select="."/>
								<MD_Keywords>
									<keyword>
										<gco:CharacterString>
											<xsl:value-of select="*[local-name()='keyword' and namespace-uri()='']"/>
											...
											<extent>
												<gml:TimePeriod>
													<xsl:attribute name="gml:id">
														<xsl:value-of select="concat('timePeriod-', position())"/>
													</xsl:attribute>
													<xsl:for-each select="*[local-name()='dateStart' and namespace-uri()='']">
														<xsl:variable name="var56_cur" select="."/>
														<xsl:choose>
															<xsl:when test="$var48_cur/*[local-name()='timeStart' and namespace-uri()='']">
																<xsl:for-each select="$var48_cur/*[local-name()='timeStart' and namespace-uri()='']">
																	<xsl:variable name="var57_cur" select="."/>
																	<xsl:choose>
																		<xsl:when test="$var48_cur/*[local-name()='timeStart' and namespace-uri()='']">
																			<xsl:for-each select="$var48_cur/*[local-name()='timezone' and namespace-uri()='']">
																				...
																				<gml:beginPosition>
																					...
																					<xsl:value-of select="concat($var56_cur, $var59_nested, $var57_cur, .)"/>
																				</gml:beginPosition>
																			</xsl:for-each>
																		</xsl:when>
																		<xsl:otherwise>
																			<gml:beginPosition>
																				...
																				<xsl:value-of select="concat($var56_cur, $var60_nested, ., '')"/>
																			</gml:beginPosition>
																		</xsl:otherwise>
																	</xsl:choose>
																</xsl:for-each>
															...
															<xsl:when test="$var48_cur/*[local-name()='timeStart' and namespace-uri()='']">
																<xsl:for-each select="$var48_cur/*[local-name()='timezone' and namespace-uri()='']">
																	...
																	<gml:beginPosition>
																		<xsl:variable name="var62_nested">
																			<xsl:choose>
																				<xsl:when test="$var48_cur/*[local-name()='timeStart' and namespace-uri()='']">
																					<xsl:value-of select="'T'"/>
																				</xsl:when>
																		...
																		<xsl:value-of select="concat($var56_cur, $var62_nested, '', .)"/>
																	</gml:beginPosition>
																</xsl:for-each>
															</xsl:when>
															<xsl:otherwise>
																<gml:beginPosition>
																	...
																	<xsl:value-of select="concat(., $var63_nested, '', '')"/>
																</gml:beginPosition>
															</xsl:otherwise>
														</xsl:choose>
													</xsl:for-each>
													<xsl:for-each select="*[local-name()='dateEnd' and namespace-uri()='']">
														...
														<xsl:choose>
															<xsl:when test="$var48_cur/*[local-name()='timeEnd' and namespace-uri()='']">
																<xsl:for-each select="$var48_cur/*[local-name()='timeEnd' and namespace-uri()='']">
																		...
																		<xsl:when test="$var48_cur/*[local-name()='timeEnd' and namespace-uri()='']">
																			<xsl:for-each select="$var48_cur/*[local-name()='timezone' and namespace-uri()='']">
																				...
																				<gml:endPosition>
																					...
																					<xsl:value-of select="concat($var64_cur, $var67_nested, $var65_cur, .)"/>
																				</gml:endPosition>
																			</xsl:for-each>
																		</xsl:when>
																		<xsl:otherwise>
																			<gml:endPosition>
																				...
																				<xsl:value-of select="concat($var64_cur, $var68_nested, ., '')"/>
																			</gml:endPosition>
																		</xsl:otherwise>
																	</xsl:choose>
																</xsl:for-each>
															...
															<xsl:when test="$var48_cur/*[local-name()='timeEnd' and namespace-uri()='']">
																<xsl:for-each select="$var48_cur/*[local-name()='timezone' and namespace-uri()='']">
																	...
																	<gml:endPosition>
																		<xsl:variable name="var70_nested">
																			<xsl:choose>
																				<xsl:when test="$var48_cur/*[local-name()='timeEnd' and namespace-uri()='']">
																					<xsl:value-of select="'T'"/>
																				</xsl:when>
																		...
																		<xsl:value-of select="concat($var64_cur, $var70_nested, '', .)"/>
																	</gml:endPosition>
																</xsl:for-each>
															</xsl:when>
															<xsl:otherwise>
																<gml:endPosition>
																	...
																	<xsl:value-of select="concat(., $var71_nested, '', '')"/>
																</gml:endPosition>
															</xsl:otherwise>
														</xsl:choose>
													</xsl:for-each>
									...
									<CI_OnlineResource>
										<linkage>
											<URL>
												...
												<xsl:value-of select="concat('http://doi.org/', $var72_nested)"/>
											</URL>
										</linkage>
										<protocol>
											<gco:CharacterString>
