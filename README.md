...
| ----------------------------- | ---------------------------------------- | ------------------------------------------------- | ----------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Resource Information          | DOI                                      | 0-1                                               | 1                                                     | `<identifier>`                                                                                                                                                              |
...
| Licenses & Rights             | Rights Title                             | 1                                                 | 0-n                                                   | 0-n `<rights>`                                                                                                                                                              |
...
|                               | rorID                                    | 0-n                                               | 0-1                                                   | `<creator><creatorName><affiliation>` lang: `<affiliation affiliationIdentifier="https://ror.org/XXXXXXXXX" affiliationIdentifierScheme="ROR" schemeURI="https://ror.org">` |
| Contact Person(s)             | Last Name                                | 1                                                 | 0-1                                                   | `<contributor><contributorName><familyName>`                                                                                                                                |
|                               | First Name                               | 1                                                 | 0-1                                                   | `<contributor><contributorName><givenName>`                                                                                                                                 |
|                               | Position                                 | 0-1                                               | 1                                                     | `<contributor contributorType="Contact Person">`                                                                                                                            |
|                               | Email adress                             | 1                                                 |                                                       |                                                                                                                                                                             |
|                               | Website                                  | 0-1                                               |                                                       |                                                                                                                                                                             |
...
|                               | LabID, laboratoryAffiliation             | 1                                                 |                                                       | `<nameIdentifier nameIdentifierScheme="labid">`and `<affiliation>`                                                                                                          |
| Contributors                  | ORCID                                    | 0-1                                               | 1 `<nameIdentifierScheme>` oder 0-1 bei `<schemeURI>` | `<nameIdentifierScheme>` or `<schemeURI>`                                                                                                                                   |
|                               | Last Name                                | 1 (only if person is specified)                   | 0-1                                                   | `<familyName>`                                                                                                                                                              |
|                               | First Name                               | 1, (only if contr. person is specified)           | 0-1                                                   | `<givenName>`                                                                                                                                                               |
|                               | Role                                     | 1-10 (only if a contributing person is specified) | 1                                                     | `<contributorType>`                                                                                                                                                         |
|                               | Affiliation                              | 0-n                                               | 0-n                                                   | `<affiliation>`                                                                                                                                                             |
|                               | Organisation Name                        | 1 (only if contr. org. is specified)              | 1                                                     | `<contributorName>`                                                                                                                                                         |
|                               | Role                                     | 1-10 (only if a contributing inst. is specified)  | 1                                                     | `<contributorType>`                                                                                                                                                         |
|                               | Affiliation                              | 0-n                                               | 0-n                                                   | `<affiliation>`                                                                                                                                                             |
...
| Dates                         | Date created                             | 1                                                 |                                                       | `dateType="Created"`                                                                                                                                                        |
|                               | Embargo until                            | 0-1                                               |                                                       | `<dateType dateType="Available">`                                                                                                                                           |
| Spatial and Temporal Coverage | Latitude Min                             | 0-1                                               |                                                       | `<geoLocations>`                                                                                                                                                            |
|                               | Latitude Max                             | 0-1                                               |                                                       | `<geoLocations>`                                                                                                                                                            |
|                               | Longitude Min                            | 0-1                                               |                                                       | `<geoLocations>`                                                                                                                                                            |
|                               | Longitude Max                            | 0-1                                               |                                                       | `<geoLocations>`                                                                                                                                                            |
|                               | Description                              | 0-1                                               | 0-1                                                   | `<geoLocationPlace>`                                                                                                                                                        |
|                               | Start Date                               | 0-1                                               |                                                       | `<dateType Collected>`                                                                                                                                                      |
|                               | Start Time                               | 0-1                                               |                                                       | `<dateType Collected>`                                                                                                                                                      |
|                               | End Date                                 | 0-1                                               |                                                       | `<dateType Collected>`                                                                                                                                                      |
|                               | End Time                                 | 0-1                                               |                                                       | `<dateType Collected>`                                                                                                                                                      |
|                               | Timezone                                 | 0-1                                               |                                                       |                                                                                                                                                                             |
