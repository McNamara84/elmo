													...
													<xsl:for-each select="*[local-name()='dateStart' and namespace-uri()='']">
														...
														<xsl:choose>
															<xsl:when test="$var25_cur/*[local-name()='timeStart' and namespace-uri()='']">
																<xsl:for-each select="$var25_cur/*[local-name()='timeStart' and namespace-uri()='']">
																	<xsl:variable name="var34_cur" select="."/>
																	<xsl:choose>
																		<xsl:when test="$var25_cur/*[local-name()='timeStart' and namespace-uri()='']">
																			<xsl:for-each select="$var25_cur/*[local-name()='timezone' and namespace-uri()='']">
																				...
																				<gml:beginPosition>
																					...
																					<xsl:value-of select="concat($var33_cur, $var36_nested, $var34_cur, .)"/>
																				</gml:beginPosition>
																			</xsl:for-each>
																		</xsl:when>
																		<xsl:otherwise>
																			<gml:beginPosition>
																				...
																				<xsl:value-of select="concat($var33_cur, $var37_nested, ., '')"/>
																			</gml:beginPosition>
																		</xsl:otherwise>
																	</xsl:choose>
																</xsl:for-each>
															...
															<xsl:when test="$var25_cur/*[local-name()='timeStart' and namespace-uri()='']">
																<xsl:for-each select="$var25_cur/*[local-name()='timezone' and namespace-uri()='']">
																	...
																	<gml:beginPosition>
																		...
																		<xsl:value-of select="concat($var33_cur, $var39_nested, '', .)"/>
																	</gml:beginPosition>
																</xsl:for-each>
															</xsl:when>
															<xsl:otherwise>
																<gml:beginPosition>
																	...
																	<xsl:value-of select="concat(., $var40_nested, '', '')"/>
																</gml:beginPosition>
															</xsl:otherwise>
														</xsl:choose>
													</xsl:for-each>
