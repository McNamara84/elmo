...
# Ensure that the standard user www-data can write runtime-generated files.
RUN mkdir -p /var/www/html/storage /var/www/html/xml \
    && chown -R www-data:www-data /var/www/html/storage /var/www/html/xml
